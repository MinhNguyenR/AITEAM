...
_STUBS = {
    ...
    "core.cli.python_cli.shell.prompt": MagicMock(GLOBAL_BACK="back", GLOBAL_EXIT="exit",
                                     normalize_global_command=lambda x: x, wait_enter=MagicMock()),
    "core.cli.python_cli.shell.nav": MagicMock(NavToMain=Exception),
    "core.cli.python_cli.ui.ui": MagicMock(clear_screen=MagicMock(), console=MagicMock()),

...
from core.routing_map import pipeline_registry_key_for_tier
from utils.delta_brief import build_state_payload
...
def leader_generate_context(
    ...
    *,
    ...
    if not quiet:
        from core.cli.ui import PASTEL_BLUE, console
    ...
    if BaseLeader.is_no_context(ctx_path):
        return None
    if not quiet:
        from core.cli.ui import PASTEL_CYAN, console

"""Run in a new terminal: `python -m core.cli.help_terminal` (see show_help external setting)."""
...
_AI_TEAM_ROOT = Path(__file__).resolve().parents[2]

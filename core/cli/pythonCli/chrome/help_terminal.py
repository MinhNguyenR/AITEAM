"""Run in a new terminal: `python -m core.cli.pythonCli.chrome.help_terminal` (see show_help external setting)."""
...
def print_help_screen() -> None:
    _ensure_path()
    from core.cli.pythonCli.command_registry import HELP_SCREEN_MARKDOWN
...
def spawn_help_in_new_terminal() -> bool:
    ...
    exe = sys.executable
    mod = "core.cli.pythonCli.chrome.help_terminal"

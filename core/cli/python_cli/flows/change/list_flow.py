...
from core.cli.python_cli.flows.change.helpers import indexed_workers, price_str
from core.cli.python_cli.nav import NavToMain
from core.cli.python_cli.chrome.ui import PASTEL_BLUE, PASTEL_CYAN, PASTEL_LAVENDER, SOFT_WHITE, clear_screen, console, print_header
...
def pick_role_key_from_indexed_workers(workers: list[dict]) -> Optional[str]:
    ...
    console.print()
    console.print(
        f"[{PASTEL_LAVENDER}]Nhập số 1–{len(workers)} để chi tiết | "

...
from core.cli.python_cli.app_menu import (
    PROJECT_ROOT,
    _run_start_entry,
    _show_context_entry,
...
from core.cli.python_cli.state import get_cli_settings
from core.cli.python_cli.chrome.ui import PASTEL_BLUE, console

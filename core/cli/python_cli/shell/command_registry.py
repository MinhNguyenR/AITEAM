...
|----------------|--------|
| **1** `/chat`   | {t('menu.chat.desc')} |
| **2** `/status` | {t('menu.status.desc')} |
| **3** `/info`   | {t('menu.info.desc')} |
| **4** `/dashboard` | {t('menu.dashboard.desc')} |
| **5** `/settings`  | {t('menu.settings.desc')} |
| **6** `/help`   | {t('menu.help.desc')} |
| **7** `/workflow` | {t('menu.workflow.desc')} |

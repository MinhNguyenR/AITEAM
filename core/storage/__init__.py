...
def __getattr__(name: str) -> Any:
    if name in {"ask_history", "ask_chat_store", "code_backup", "graphrag_store", "knowledge_store"}:
...
__all__ = sorted([*_EXPORTS, "ask_history", "ask_chat_store", "code_backup", "graphrag_store", "knowledge_store"])
